...
- **人口地图**：默认关闭；按需加载 WorldPop 100 米人口密度 ImageServer 影像图层，显示 2000–2020 年数据中的 2020 年全球估算。地图按固定阈值（0、10、50、150、500、2,000、10,000、20,000、30,000、40,000、50,000 人/平方公里）将密度重分类为浅蓝到浅红的颜色梯度；整体图层透明度降低以保留底图细节，50,000 及以上使用最深档，分级图例显示在底部控制卡片下方。栅格按地图瓦片范围实时请求；下拉菜单每次只启用一种叠加图层。
