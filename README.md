...
- **人口地图**：默认关闭；按需加载 WorldPop 100 米人口密度 ImageServer 影像图层，显示 2000–2020 年数据中的 2020 年全球估算。地图按固定阈值（0、10、50、150、500、2,000、10,000 人/平方公里）将密度重分类为黄到红的颜色渐变，并在图层下方显示图例。栅格按地图瓦片范围实时请求；下拉菜单每次只启用一种叠加图层。
